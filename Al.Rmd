...
plot_rich_reads_samlenames_lm(ps.f.s7307.wIn)

ps.f.s7307.wIn <- prune_samples(sample_data(ps.f.s7307)$Inoculation %in% c("-"), ps.f.s7307)
ps.f.s7307.wIn <- prune_taxa(taxa_sums(ps.f.s7307.wIn) > 0,ps.f.s7307.wIn)

ps.f.s7307.wIn
beta_custom_norm_NMDS_elli_uni(ps.f.s7307.wIn)

beta_custom_norm_NMDS_elli_uni <- function(ps, seed = 7888, normtype="vst", color="Repeats"){
  require(phyloseq)
  require(ggplot2)
  require(ggpubr)
  require(DESeq2)
  ...
  #plotting
  p1 = plot_ordination(ps, ordination.b, type="Description", color="Al", title="NMDS - Bray", 
                       axes = c(1,2) ) + theme_bw() + theme(text = element_text(size = 10)) + geom_point(size = 3) 
  
  p2 = plot_ordination(ps, ordination.u, type="Description", color="Al", title="NMDS - unifrac", 
                       axes = c(1,2) ) + theme_bw() + theme(text = element_text(size = 10)) + geom_point(size = 3) 
  
  p3 = plot_ordination(ps, ordination.w, type="Description", color="Al", title="NMDS - wunifrac", 
                       axes = c(1,2) ) + theme_bw() + theme(text = element_text(size = 10)) + geom_point(size = 3) 
